...
/*   Updated: 2022/12/16 12:38:33 by gialexan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	push_a(t_data *data)
{
	...
	if (data->stack_a == NULL)
		...
		lstadd_front(&data->stack_a, lstnew(data->stack_b->number, data->stack_b->index));
...
void	push_b(t_data *data)
{
	...
	if (data->stack_b == NULL)
		...
		lstadd_front(&data->stack_b, lstnew(data->stack_a->number, data->stack_a->index));
